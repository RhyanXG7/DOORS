...
local SniperGroupbox = Tabs.lobby:AddLeftGroupbox("Sniper") do
    SniperGroupbox:AddToggle("ElevatorSniper", {
        Text = "Elevator Sniper"        Default = false
    })

    SniperGroupbox:AddDropdown("ElevatorSniperTarget", {
o        SpecialType = "Player",
        Multi = false,

b        Text = "Target"    })
end

local OtherGroupbox = Tabs.lobby:AddRightGroupbox("Other") do
