...
do
    ...
    function Script.Functions.AutoWardrobe(child, index: number | nil) -- child = entity, ty upio
        ...
        task.spawn(function() 
            Script.Functions.Log({
                ...
                LinoriaMessage = "[" .. NotifPrefix .. "] Procurando um esconderijo..."
        ...
        task.spawn(function() 
            Script.Functions.Log({
                ...
                LinoriaMessage = "[" .. NotifPrefix .. "] Começando..."
            }, Toggles.AutoWardrobeNotif.Value)
        end)
                ...
                repeat task.wait(.15)
                    ...
                    if didPlayerSeeEntity == true and isSafe == true then
                        task.spawn(function() 
                            Script.Functions.Log({
                                Title = NotifPrefix,
                                Description = "Saindo do armário, a entidade está longe.",
                        ...
                        if isSafe == true and not child:IsDescendantOf(workspace) then 
                            task.spawn(function() 
                                Script.Functions.Log({
                                    Title = NotifPrefix,
                                    Description = "Ao sair do armário, a entidade é excluída.",
                                    
                                    LinoriaMessage = "[" .. NotifPrefix .. "] Ao sair do armário, a entidade é excluída."
                                }, Toggles.AutoWardrobeNotif.Value)
                            end)
                    ...
                    if not alive then  
                        if Toggles.AutoWardrobeNotif.Value then Script.Functions.Log("[" .. NotifPrefix .. "] Parando (você morreu).") end             
                        task.spawn(function() 
                            Script.Functions.Log({
                                Title = NotifPrefix,
                                Description = "Parando (você morreu)",
                                
                                LinoriaMessage = "[" .. NotifPrefix .. "] Parando (você morreu)."
                            }, Toggles.AutoWardrobeNotif.Value)
                        end)
        ...
        if child.Name == "AmbushMoving" then
            ...
            repeat task.wait()
                task.spawn(function() 
                    Script.Functions.Log({
                        Title = NotifPrefix,
                        Description = "Esperando que Ambush esteja perto o suficiente...",
        
                        LinoriaMessage = "[" .. NotifPrefix .. "] Esperando que Ambush esteja perto o suficiente...",
                    }, Toggles.AutoWardrobeNotif.Value)
                end)
                ...
                if success then
                    task.spawn(function() 
                        Script.Functions.Log({
                            Title = NotifPrefix,
                            Description = "Esperando que seja seguro sair...",
        
                            LinoriaMessage = "[" .. NotifPrefix .. "] Esperando que seja seguro sair...",
                        }, Toggles.AutoWardrobeNotif.Value)
                    end)
        ...
        task.spawn(function() 
            Script.Functions.Log({
                ...
                LinoriaMessage = "[" .. NotifPrefix .. "] Finalizado.",
            }, Toggles.AutoWardrobeNotif.Value)
        end)
    end
    ...
    function Script.Functions.SolveBreakerBox(breakerBox)
        ...
        Script.Functions.Alert({
            Title = "Solucionador de Disjuntor Automático",
            Description = "Resolvendo o problema da caixa de disjuntores...",
            Reason = ""
        })
        ...
        if Options.AutoBreakerSolverMethod.Value == "Legit" then
            ...
            Script.Functions.Alert({
                Title = "Solucionador de Disjuntor Automático",
                Description = "O problema da caixa de disjuntores foi resolvido com sucesso.",
            })
        end
    end
...
do
    ...
    local function NodeDestroy(nodesList: tSortedNodes)
        ...
        print("[Rseeker × Paint] Tentando destruir nós na sala: " .. tostring(nodesList.roomNumber))
    ...
    function Script.Functions.Minecart.Teleport(room: Model)
        ...
        if roomNumber == 45 and not hasAlreadyTeleported then
            task.spawn(function()
                ...
                Script.Functions.Alert({
                    Title = "Teletransporte de carrinho de mina",
                    Description = "Teleporte de minecart pronto! Esperando o minecart...",
    
                    Time = progressPart
                })
            end)

            debugMinecart("[Teletransporte] Sala de inicialização do teletransporte do carrinho de mina:" .. room.Name)
            ...
            while #minecartRigs == 0 and not Library.Unloaded do 
                task.wait(0.5)
                debugMinecart("[Teleport] Espaço para Teletransporte: " .. tostring(latestRoom.Value))
            end
            ...
            Script.Functions.Alert({
                Title = "Teletransporte de carrinho de mina",
                Description = "Teleporte de Minecart iniciado. Aproveite o passeio!",
            ...
            if character then
                Script.Connections["AnticheatBypassTheMines"] = character:GetAttributeChangedSignal("Climbing"):Connect(function()                                
                    if Toggles.TheMinesAnticheatBypass.Value and character:GetAttribute("Climbing") then
                        ...
                        Script.Functions.Alert({
                            Title = "Bypass anti-fraude",
                            Description = "Contornou o anticheat com sucesso!",
                            Reason = "Isso só vai durar até a próxima cena!",
    
                            LinoriaMessage = "Contornou o anticheat com sucesso! Isso só vai durar até a próxima cutscene",
